...
#ifndef __XFBURN_BURN_IMAGE_PROGRESS_DIALOG_H__
#define __XFBURN_BURN_IMAGE_PROGRESS_DIALOG_H__
...
#define XFBURN_TYPE_BURN_IMAGE_PROGRESS_DIALOG         (xfburn_burn_image_progress_dialog_get_type ())
#define XFBURN_BURN_IMAGE_PROGRESS_DIALOG(o)           (G_TYPE_CHECK_INSTANCE_CAST ((o), XFBURN_TYPE_BURN_IMAGE_PROGRESS_DIALOG, XfburnBurnImageProgressDialog))
#define XFBURN_BURN_IMAGE_PROGRESS_DIALOG_CLASS(k)     (G_TYPE_CHECK_CLASS_CAST((k), XFBURN_TYPE_BURN_IMAGE_PROGRESS_DIALOG, XfburnBurnImageProgressDialogClass))
#define XFBURN_IS_BURN_IMAGE_PROGRESS_DIALOG(o)        (G_TYPE_CHECK_INSTANCE_TYPE ((o), XFBURN_TYPE_BURN_IMAGE_PROGRESS_DIALOG))
...
} XfburnBurnImageProgressDialogClass;
